...
public class OrdemDeServico extends ModelBanco {
	...
	public OrdemDeServico(Pessoa cliente, Pessoa funcionario, br.com.tanaka.danilo.JPA.model.Veiculo veiculo, Date data,
			Date dataEntrada, Date dataOrdemDeServico, Date dataInicioServico, Date dataFimServico, Date dataEntrega,
			float desconto) {
		Cliente = cliente;
